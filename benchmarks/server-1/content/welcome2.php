...
<html>
  <head>
    ...
    <title>Welcome AGAIN "<?php echo $_SESSION['name']; ?>" (<?php echo $_SESSION['username']; ?>) to the test page 2!</title>
  ...
  <body>
    <h1>Welcome AGAIN <?php echo $_SESSION['name'] . ' (' . $_SESSION['username'] . ')'; ?></h1>
